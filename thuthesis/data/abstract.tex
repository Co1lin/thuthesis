...
\begin{abstract}
    ...
    面对上述问题，在方法上，本课题提出符号化计算图生成这一已有算法的一种改进策略，通过引入具体化算子进行混合计算图生成，提高了模糊测试用例中计算图的多样性。实验表明，对于 PyTorch 与 TensorFlow 两种主流框架，该方法可以分别提高分支覆盖率 x\% 、 y\% ，研究过程中累计提交漏洞 a 个、 b 个，且在测例多样性与实际意义两方面均具有明显优势。
